...
export default function FloatingActionButtonZoom() {
    ...
    useEffect(() => {
      ProfileCallOnClick(profile.email);
    }, []);


    return (

        <div onLoad={ProfileCallOnClick}>
            <Appbar />
          ...
          <MDBCol lg="4">
            <MDBCard className="mb-4">
              <MDBCardBody className="text-center">
                ...
                <p className="text-muted mb-1">{profile.course}</p>
            ...
            <MDBCard className="mb-4">
              <MDBCardBody>
                <MDBRow>
                  ...
                  <MDBCol sm="9">
                    <MDBCardText className="text-muted">{profile.first_name} {profile.last_name}</MDBCardText>
                  </MDBCol>
                </MDBRow>
                <hr />
                <MDBRow>
                ...
                <MDBRow>
                  ...
                  <MDBCol sm="9">
                    <MDBCardText className="text-muted">+91 {profile.mobile}</MDBCardText>
                  </MDBCol>
                </MDBRow>
                <hr />
                <MDBRow>
                  ...
                  <MDBCol sm="9">
                    <MDBCardText className="text-muted">{profile.emp_id}</MDBCardText>
                  </MDBCol>
                </MDBRow>
              </MDBCardBody>
            </MDBCard>
